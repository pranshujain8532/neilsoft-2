...
class InventoryEnvironment:
    def __init__(self, container_capacity: float = 10000):
        ...
        self.current_level = container_capacity * 0.5 
        self.daily_demand = 200 
        self.lead_time = 3 
        ...
        self.holding_cost_per_kg = 0.5 
        self.stockout_cost_per_kg = 10.0 
        self.order_cost_fixed = 100 
        self.order_cost_per_kg = 5.0 
    ...
    def _get_state(self) -> np.ndarray:
        ...
        demand_rate = self.daily_demand / 300 
    ...
    def step(self, action: int) -> Tuple[np.ndarray, float, bool, Dict]:
        order_amounts = [0, 0.1, 0.25, 0.5, 0.75] 
        ...
        demand_today = self.daily_demand * np.random.uniform(0.8, 1.2) 
        
        if self.current_level >= demand_today:
            self.current_level -= demand_today
            reward -= self.current_level * self.holding_cost_per_kg / 100 
        else:
