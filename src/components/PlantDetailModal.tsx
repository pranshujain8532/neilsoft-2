...
import { X, Factory, DollarSign, Activity, Zap, Users, AlertTriangle } from 'lucide-react';
...
const PlantDetailModal: React.FC<PlantDetailModalProps> = ({ plant, onClose }) => {
    ...
    const dailyProfit = plant.profit_prediction?.daily_profit || 0; // Should match Revenue - Cost roughly

    // Derived Cost Breakdown (Simulated distribution of LCOH)
    // Energy is usually the biggest chunk for electrolysis
    const costBreakdown = {
    ...
    // Operational Metrics (Simulated/Derived)
    ...
    const productionLines = Math.floor(maxCapacity / 500) + 1; // Approx 500kg per line
    const employeeCount = Math.floor(productionLines * 4.5); // Staffing model
                ...
                >
                    ...
                    <div className="sticky top-0 z-10 flex items-center justify-between p-6 bg-gray-900/95 border-b border-gray-800 backdrop-blur-md">
                        <div className="flex items-center gap-4">
                            <div className="p-3 rounded-xl bg-gradient-to-br from-hydrogen-500 to-blue-600 shadow-lg shadow-blue-500/20">
                        ...
                        <section className="bg-gray-800/30 rounded-xl p-6 border border-gray-700/50">
                            ...
                            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                                ...
                                <div className="bg-gray-900/50 p-4 rounded-xl text-center border border-gray-700/30">
                                    ...
                                    <div className="text-2xl font-bold text-white">{plant.energy_output?.total} MW</div>
